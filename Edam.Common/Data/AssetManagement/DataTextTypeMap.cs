...
namespace Edam.Data.AssetManagement
{
   ...
   public class DataTextElementInstanceInfo
   {
         ...
         DataTextElementInfo mapElement)
      {
         m_Element = element;
         m_ElementName = 
            DataElementHelper.GetUnqualifyText(element.ElementName);
         m_EntityName = 
            DataElementHelper.GetUnqualifyText(element.EntityName);
         m_DataTypeName = 
            DataElementHelper.GetUnqualifyText(element.ElementDataType).
               Replace(" ", "_");
